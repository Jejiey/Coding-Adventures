...
if ( BlueSpots == 2 || BlueSpots == 3 && Blue )
    NextPixels[i][2] =  1;
...
slider.oninput = function() {
  window.updatingspeed =  speed * ((1 + this.value)/1000) ;
...
if(coords[2] == 2)
 window.ctx.fillStyle = 'hsl( 198,100%,40%)';

if(coords[2] == 0)
 window.ctx.fillStyle = 'hsl( 22,100%,50%)';

if(coords[2] == 1)
 window.ctx.fillStyle = 'hsl( 173,58%,0%)';
